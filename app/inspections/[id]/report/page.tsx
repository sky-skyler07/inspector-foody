...
export default function ReportPage({
  ...
  const warnings = inspection.checks.filter(
    (c) => c.status === 'warning'
  );

  const failed = inspection.checks.filter(
    (c) => c.status === 'failed'
  );
          ...
          <CardContent className="p-8 lg:p-12">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">
                      {inspection.product.manufacturer ||
                        'Not detected'}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">
                      {inspection.product.countryOfOrigin ||
                        'Not detected'}
                    </p>
                  </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-around gap-6 border-y border-border py-6 mb-8">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <ReviewBadge
                  status={inspection.reviewStatus}
                />
            ...
            <div className="mt-8 pt-6 border-t border-border text-center">
              ...
              <p className="text-xs text-muted-foreground">
                This report was generated by Inspector Foody ·
                Scan. Inspect. Verify.
              </p>

              <p className="text-xs text-muted-foreground mt-1">
                Automated prototype inspection report based
                on detected label information.
              </p>
